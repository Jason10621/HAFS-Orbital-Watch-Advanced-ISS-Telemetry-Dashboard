// =======================================================================
// HAFS Grand Observatory (V16.0 Absolute Master Core)
// Project Creator: 10621 이정욱
// Rules Enforced: 100% Quantity Preservation, Unlimited Length.
// Added: MODULE 05 (Stellar Lifecycle) with Dynamic Astro-Physics Interpolation
// =======================================================================
...
const DB = {
    ...
    solarsystem: [
        ...
        { 
            ...
            moons: [
                {id:"luna", name:"Luna (달)", r:0.5, d:4, speed:0.08, color:0xaaaaaa, img: "https://upload.wikimedia.org/wikipedia/commons/e/e1/FullMoon2010.jpg", desc:"지구와의 조석 고정으로 항상 같은 면만 보입니다. 밀물과 썰물을 만들어냅니다.", period: "27.3 Days", grav: "1.62 m/s²"}
            ] 
        },
        { 
        ...
        { 
            ...
            desc: "태양계에서 가장 거대한 가스 행성.", details: "내부의 거대한 액체 금속 수소 바다가 초강력 자기장을 만들어냅니다. 수백 년간 지속되는 대적점 폭풍이 특징입니다.", 
            atm: [{n: "수소", p: 89, c: "#4da6ff"}, {n: "헬륨", p: 10, c: "#ffcc99"}], internal: [{n: "기체 수소", p: 15, c: "#ffeebb"}, {n: "액체 금속 수소", p: 70, c: "#99aacc"}, {n: "암석 코어", p: 15, c: "#444444"}], 
            moons: [
                {id:"io", name:"Io", r:0.4, d:7, speed:0.12, color:0xffff00, img: "https://upload.wikimedia.org/wikipedia/commons/7/7b/Io_highest_resolution_true_color.jpg", desc:"목성의 가공할 조석력으로 내부가 끓어올라, 태양계에서 가장 화산 활동이 활발한 지옥 같은 위성입니다.", period: "1.7 Days", grav: "1.79 m/s²"}, 
                {id:"europa", name:"Europa", r:0.35, d:9, speed:0.09, color:0xeeeeee, img: "https://upload.wikimedia.org/wikipedia/commons/e/e4/Europa-moon.jpg", desc:"표면의 두꺼운 얼음 지각 아래에 거대한 양의 액체 물이 존재하여 생명체 탐사 1순위로 꼽힙니다.", period: "3.5 Days", grav: "1.31 m/s²"},
                {id:"ganymede", name:"Ganymede", r:0.6, d:11, speed:0.07, color:0xaaaaaa, img: "https://upload.wikimedia.org/wikipedia/commons/f/f2/Ganymede_g1_true.jpg", desc:"태양계에서 가장 큰 위성으로, 수성보다도 큽니다. 유일하게 자체 자기장을 가지고 있습니다.", period: "7.1 Days", grav: "1.42 m/s²"},
                {id:"callisto", name:"Callisto", r:0.55, d:13, speed:0.05, color:0x888888, img: "https://upload.wikimedia.org/wikipedia/commons/e/e9/Callisto.jpg", desc:"크레이터가 가장 밀집된 천체로, 지질학적 활동이 전혀 없이 죽어있는 위성입니다.", period: "16.6 Days", grav: "1.23 m/s²"}
            ] 
        },
        { 
            ...
            temp: "-140°C", orb: "9.69", 
            desc: "아름다운 고리 시스템을 가진 거대 가스 행성.", details: "평균 밀도가 물보다 낮아 바다가 있다면 둥둥 뜰 수 있습니다. 수많은 얼음 조각들로 이루어진 광대한 고리를 가졌습니다.", 
            ...
            moons: [
                {id:"titan", name:"Titan", r:0.7, d:8, speed:0.05, color:0xffaa55, img: "https://upload.wikimedia.org/wikipedia/commons/9/90/Titan_in_true_color.jpg", desc:"지구보다 더 짙은 질소 중심의 대기를 가지고 있으며, 표면에 메탄 호수가 흐르는 위성입니다.", period: "15.9 Days", grav: "1.35 m/s²"},
        ...
        { 
            ...
            temp: "-195°C", orb: "6.81", 
            desc: "자전축이 98도 기울어져 누운 채로 공전하는 얼음 거성.", details: "태양계 형성 초기에 충돌하여 자전축이 꺾인 것으로 추정됩니다. 메탄 가스로 인해 청록색으로 보입니다.", 
            ...
            moons: [
                {id:"miranda", name:"Miranda", r:0.1, d:4, speed:0.06, color:0x999999, img: "https://upload.wikimedia.org/wikipedia/commons/e/e0/Miranda.jpg", desc:"수많은 단층과 협곡으로 표면이 심하게 짜깁기된 듯한 누더기 모양의 위성입니다.", period: "1.4 Days", grav: "0.07 m/s²"},
                {id:"titania", name:"Titania", r:0.25, d:6, speed:0.04, color:0xbbbbbb, img: "https://upload.wikimedia.org/wikipedia/commons/0/0c/Titania_%28moon%29.jpg", desc:"천왕성의 위성 중 가장 크며, 더러운 얼음과 암석으로 이루어져 있습니다.", period: "8.7 Days", grav: "0.37 m/s²"}
            ] 
        },
        { 
            ...
            temp: "-200°C", orb: "5.43", 
            desc: "초음속 강풍이 부는 태양계 최외곽 얼음 거성.", details: "미스터리한 내부 열원으로 인해 시속 2,100km에 달하는 태양계에서 가장 폭력적인 바람이 붑니다.", 
    ...
    probes: [
        ...
        { id: "pioneer10", name: "PIONEER 10", launch: "1972", target: "Jupiter", distAU: 135.0, vel: "11.9", img: "https://upload.wikimedia.org/wikipedia/commons/f/f0/Pioneer_10_spacecraft.png", power: 0, desc: "최초로 목성을 탐사하고 소행성대를 통과한 우주선.", details: "통신 두절 상태로 관성 비행 중입니다.", angle: Math.PI * 1.3 },
        { id: "pioneer11", name: "PIONEER 11", launch: "1973", target: "Saturn", distAU: 111.0, vel: "11.2", img: "https://upload.wikimedia.org/wikipedia/commons/f/f0/Pioneer_10_spacecraft.png", power: 0, desc: "목성과 토성을 탐사한 개척선.", details: "1995년에 통신이 끊겼습니다.", angle: Math.PI * 1.5 },
        { id: "newhorizons", name: "NEW HORIZONS", launch: "2006", target: "Pluto/Kuiper", distAU: 58.0, vel: "13.8", img: "https://upload.wikimedia.org/wikipedia/commons/f/fb/New_Horizons_Transparent.png", power: 75, desc: "명왕성과 카이퍼 벨트를 탐사 중인 우주선.", details: "명왕성의 하트 지형을 촬영했습니다.", angle: Math.PI },
        { id: "cassini", name: "CASSINI-HUYGENS", launch: "1997", target: "Saturn System", distAU: 9.5, vel: "Orbiting", img: "https://upload.wikimedia.org/wikipedia/commons/b/b2/Cassini_Saturn_Orbit_Insertion.jpg", power: 0, desc: "토성계의 비밀을 밝혀낸 위대한 탐사선.", details: "2017년 임무를 종료(그랜드 피날레)했습니다.", angle: Math.PI * 0.7 },
        { id: "rosetta", name: "ROSETTA", launch: "2004", target: "Comet 67P", distAU: 3.5, vel: "Landed", img: "https://upload.wikimedia.org/wikipedia/commons/1/1b/Rosetta_spacecraft.png", power: 0, desc: "인류 최초로 혜성 표면에 착륙한 탐사선.", details: "태양계 초기의 화학적 성분을 분석했습니다.", angle: Math.PI * 0.2 }
    ],
    GenesisData: [
        { t: 0, epoch: "SINGULARITY", age: "0 Years", temp: "10^32 K", size: "10^-35 m", comp: "Unified Superforce", redshift: "Infinite", desc: "빅뱅. 모든 물질과 에너지가 한 점에 응축된 우주의 시작.", details: "물리 법칙이 적용되지 않는 플랑크 시대입니다.", img: "https://upload.wikimedia.org/wikipedia/commons/6/6f/CMB_Timeline300_no_WMAP.jpg" },
        { t: 10, epoch: "INFLATION", age: "10^-32 s", temp: "10^27 K", size: "10 cm", comp: "Quark-Gluon Plasma", redshift: "> 10^25", desc: "빛보다 빠른 급팽창으로 구조의 씨앗이 뿌려집니다.", details: "쿼크와 글루온이 떠다니는 초고온 플라즈마 상태입니다.", img: "https://upload.wikimedia.org/wikipedia/commons/3/37/Universe_expansion2.png" },
        { t: 30, epoch: "RECOMBINATION", age: "380,000 Yrs", temp: "3,000 K", size: "42 Mly", comp: "Photons", redshift: "z = 1,100", desc: "원자가 형성되고 빛이 퍼져나가며 우주 배경 복사가 됩니다.", details: "우주가 투명해진 첫 번째 순간입니다.", img: "https://upload.wikimedia.org/wikipedia/commons/3/3c/Ilc_9yr_moll4096.png" },
        { t: 60, epoch: "DARK AGES", age: "400 M Yrs", temp: "30 K", size: "1 Bly", comp: "Dark Matter", redshift: "z = 20", desc: "거대 수소 구름이 뭉쳐 제1세대 항성이 탄생합니다.", details: "초신성 폭발로 무거운 원소가 우주에 흩뿌려집니다.", img: "https://upload.wikimedia.org/wikipedia/commons/e/e4/Webb%27s_First_Deep_Field.jpg" },
        { t: 100, epoch: "PRESENT UNIVERSE", age: "13.8 B Yrs", temp: "2.7 K", size: "93 Bly", comp: "Dark Energy (68%)", redshift: "z = 0", desc: "거대 구조(Cosmic Web)가 형성된 현재의 우주입니다.", details: "암흑 에너지가 우주 팽창을 가속화시키고 있습니다.", img: "https://upload.wikimedia.org/wikipedia/commons/4/43/ESO-VLT-Laser-phot-33a-07.jpg" }
    ]
};

// [신규] MODULE 05 천체물리학 데이터 (별의 일생)
const SLData = [
    { temp: 50, lum: 0.001, radius: 100000, color: 0xaabbff, name: "Stellar Nebula (분자 구름)" },
    { temp: 3000, lum: 1, radius: 5, color: 0xff6600, name: "Protostar (원시성)" },
    { temp: 15000, lum: 1000, radius: 3, color: 0xffffff, name: "Main Sequence (주계열성)" },
    { temp: 4000, lum: 50000, radius: 200, color: 0xff3300, name: "Red Giant (거성)" },
    { temp: 25000, lum: 0.01, radius: 0.01, color: 0xaaddff, name: "White Dwarf (백색왜성)" },
    { temp: 1000000, lum: 0.001, radius: 0.00001, color: 0xffffff, name: "Neutron Star (중성자별)" },
    { temp: 0, lum: 0, radius: 0, color: 0x000000, name: "Black Hole (블랙홀)" }
];
...
const DOM = {
    ...
    uiSL: document.getElementById('ui-stellar'), // 신규
    
    // DS
    dsTargets: document.querySelectorAll('.ds-target'), dsInfo: document.getElementById('ds-info'), dsTitle: document.getElementById('ds-title'), dsMedia: document.getElementById('ds-media'), dsDesc: document.getElementById('ds-desc'), dsDetails: document.getElementById('ds-details'), dsNormal: document.getElementById('ds-normal-info'), dsSubList: document.getElementById('ds-sub-list'), dsBHCtrl: document.getElementById('ds-bh-controls'), bhMass: document.getElementById('bh-mass'), bhDist: document.getElementById('bh-dist'), dsMetricsBar: document.getElementById('ds-metrics-bar'), dsMetricsLegend: document.getElementById('ds-metrics-legend'),
    
    // SS
    ssList: document.getElementById('ss-planet-list'), ssSpeed: document.getElementById('ss-speed'), ssBtnReset: document.getElementById('btn-ss-reset'), ssInfo: document.getElementById('ss-info'), ssName: document.getElementById('ss-name'), ssMedia: document.getElementById('ss-media'), ssDesc: document.getElementById('ss-desc'), ssDetails: document.getElementById('ss-details'), ssTemp: document.getElementById('ss-temp'), ssOrb: document.getElementById('ss-orb'), ssCompBar: document.getElementById('ss-comp-bar'), ssCompLegend: document.getElementById('ss-comp-legend'), ssInternalBar: document.getElementById('ss-internal-bar'), ssInternalLegend: document.getElementById('ss-internal-legend'), ssMoonsCont: document.getElementById('ss-moons-container'), ssMoonsList: document.getElementById('ss-moons-list'), ssPlanetData: document.getElementById('ss-planet-data'), ssMoonData: document.getElementById('ss-moon-data'), ssMoonPeriod: document.getElementById('ss-moon-period'), ssMoonGrav: document.getElementById('ss-moon-grav'),
    
    // PR
    prList: document.getElementById('pr-list'), btnPrReset: document.getElementById('btn-pr-reset'), prInfo: document.getElementById('pr-info'), prName: document.getElementById('pr-name'), prMedia: document.getElementById('pr-media'), prDesc: document.getElementById('pr-desc'), prDetails: document.getElementById('pr-details'), prLaunch: document.getElementById('pr-launch'), prTarget: document.getElementById('pr-target'), prPowerBar: document.getElementById('pr-power-bar'), prDist: document.getElementById('pr-dist'), prVel: document.getElementById('pr-vel'), prDelay: document.getElementById('pr-delay'),

    // GN
    gnTimeline: document.getElementById('gn-timeline'), gnEpoch: document.getElementById('gn-epoch'), gnAge: document.getElementById('gn-age'), gnTemp: document.getElementById('gn-temp'), gnMedia: document.getElementById('gn-media'), gnDesc: document.getElementById('gn-desc'), gnDetails: document.getElementById('gn-details'), gnSize: document.getElementById('gn-size'), gnComp: document.getElementById('gn-comp'), gnRedshift: document.getElementById('gn-redshift'),
...
// ================= [ M2: SOLAR SYSTEM (8 Planets & 13 Moons) ] =================
...
// ================= [ M3: INTERSTELLAR PROBES (7 Probes) ] =================
...
// ================= [ M5: STELLAR LIFECYCLE ENGINE (별의 일생과 HR도) ] =================
function launchStellar() {
    ...
    for(let i=0; i<SLEngine.count; i++) {
        ...
        setPos(SLEngine.pos0, 300, 200);  // 성운
        setPos(SLEngine.pos1, 80, 50);    // 원시성
        setPos(SLEngine.pos2, 5, 2);      // 주계열성
        setPos(SLEngine.pos3, 150, 20);   // 거성
        setPos(SLEngine.pos4, 400, 100);  // 초신성 잔해
